...
export const compositionRules: Record<string, {
  description: string;
  principles: string[];
  avoid: string[];
}> = {
...
export function getCompositionDirective(storyType: StoryType): CompositionDirective {
  const defaults: Record<string, CompositionDirective> = {
    'breaking-news': {
