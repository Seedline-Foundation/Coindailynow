...
export const motionRules: Record<string, {
  description: string;
  directives: string[];
...
export function getMotionDirective(storyType: StoryType): MotionDirective {
  const defaults: Record<string, MotionDirective> = {
    'breaking-news': {
