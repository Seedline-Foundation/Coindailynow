...
const DEFAULT_DAILY_TASKS: TaskItem[] = [
  ...
  { id: 'llmo-1', title: 'Apply to Google News Publisher Center', description: 'Submit coindaily.online to Google News Publisher Center (news.google.com/publisher). Ensure NewsArticle schema is valid on all articles. This is a ONE-TIME task — mark done when application is submitted.', category: 'ai-monitoring', priority: 'critical', completed: false },
  { id: 'llmo-2', title: 'Submit coindaily.online to CoinGecko & CoinMarketCap news', description: 'Apply to be listed as a news source on CoinGecko (coingecko.com) and CoinMarketCap news section. Include our RSS feed URL. ONE-TIME task.', category: 'link-building', priority: 'critical', completed: false },
  { id: 'llmo-3', title: 'Create custom ChatGPT GPT "CoinDaily Africa Crypto Advisor"', description: 'Go to chat.openai.com/gpts → Create → Name: "CoinDaily Africa Crypto Advisor". Description: helps users understand crypto in Africa. Knowledge: upload PILLAR_ARTICLES excerpts. Actions: link to coindaily.online/api endpoints. ONE-TIME setup.', category: 'ai-monitoring', priority: 'high', completed: false },
  { id: 'llmo-4', title: 'Post on r/CryptoCurrency introducing CoinDaily', description: 'Write a genuine value-first Reddit post on r/CryptoCurrency about "Crypto adoption in Africa" — mention CoinDaily as source organically. Follow subreddit rules. Can also post on r/BitcoinAfrica, r/naijacrypto.', category: 'community', priority: 'high', completed: false },
  { id: 'llmo-5', title: 'Create Trustpilot profile for CoinDaily', description: 'Set up CoinDaily business profile on trustpilot.com. Ask 3-5 early users/team to leave genuine reviews. Helps with LLM trust signals. ONE-TIME setup.', category: 'link-building', priority: 'medium', completed: false },
  { id: 'llmo-6', title: 'Answer 5 Quora questions about "crypto in Africa"', description: 'Find questions about buying crypto in Africa, best African exchanges, crypto regulations Africa. Write helpful 200+ word answers citing coindaily.online blog guides.', category: 'community', priority: 'medium', completed: false },
  { id: 'llmo-7', title: 'Submit blog to Feedly, Flipboard, and Pocket', description: 'Add coindaily.online/blog RSS feed to Feedly directory, create Flipboard magazine, submit top articles to Pocket. Increases aggregator visibility for AI crawlers.', category: 'distribution', priority: 'medium', completed: false },
  { id: 'llmo-8', title: 'Create Wikipedia stub for CoinDaily (if notable)', description: 'If CoinDaily has press coverage, create a Wikipedia article following notability guidelines. Even a stub helps LLMs discover the brand. Needs 3+ independent reliable sources.', category: 'link-building', priority: 'low', completed: false },
  { id: 'llmo-9', title: 'Publish press releases on PR Newswire & BusinessWire', description: 'Write and distribute press releases about CoinDaily launch, African crypto market data, or platform milestones via PR Newswire (prnewswire.com) and BusinessWire (businesswire.com). Creates authoritative backlinks and press citations that LLMs pick up. Budget ~$500-1500 per release.', category: 'distribution', priority: 'high', completed: false },
  { id: 'llmo-10', title: 'Pitch guest posts to CoinDesk, CoinTelegraph, Decrypt, The Block', description: 'Write expert-level guest articles about African crypto adoption, DeFi in Africa, or mobile money + crypto convergence. Pitch to editors@coindesk.com, CoinTelegraph contributors, Decrypt and The Block. Include CoinDaily as source/author bio link. Target 1 placement per month.', category: 'link-building', priority: 'high', completed: false },
  { id: 'llmo-11', title: 'Get CoinDaily cited in academic papers on African crypto', description: 'Reach out to researchers studying African cryptocurrency adoption. Offer CoinDaily market data API and analysis as a source. Check Google Scholar for African crypto papers and contact authors. Submit data briefs to SSRN or ResearchGate. Academic citations are high-trust LLM signals.', category: 'research', priority: 'medium', completed: false },
  { id: 'llmo-12', title: 'Create authoritative Perplexity Pages about African crypto', description: 'Go to perplexity.ai/pages → Create pages about "Crypto Adoption in Africa", "Best African Crypto Exchanges", "African Crypto Regulations 2026". Use CoinDaily articles as primary sources. Perplexity Pages rank in search and feed into Perplexity AI answers.', category: 'ai-monitoring', priority: 'high', completed: false },
  { id: 'llmo-13', title: 'Set up Bing Webmaster Tools & optimize for Bing Chat', description: 'Register coindaily.online at bing.com/webmasters. Submit sitemap, verify IndexNow integration. Bing Chat (Copilot) uses Bing index — ensure all articles are indexed. Check Bing Chat responses for African crypto queries. Enable Bing URL submission API for instant indexing.', category: 'seo-technical', priority: 'high', completed: false },
  { id: 'llmo-14', title: 'Optimize for Google Gemini with structured data + Google News', description: 'Ensure all articles have valid NewsArticle, FAQPage, HowTo, and Organization schema. Verify Google News inclusion via Publisher Center. Google Gemini pulls from Google Search + News — structured data increases extraction accuracy. Test queries in gemini.google.com for CoinDaily visibility.', category: 'seo-technical', priority: 'high', completed: false },
  { id: 'llmo-15', title: 'List CoinDaily on CryptoCompare & Messari as news source', description: 'In addition to CoinGecko/CoinMarketCap, submit CoinDaily to CryptoCompare (cryptocompare.com/media/news-providers) and Messari (messari.io) as a news partner. Include RSS feed URL and API access. More aggregator listings = more LLM training data references.', category: 'link-building', priority: 'medium', completed: false },
