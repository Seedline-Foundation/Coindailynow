...
const DEFAULT_DAILY_TASKS: TaskItem[] = [
  ...
  { id: 'llmo-3', title: 'Create custom ChatGPT GPT "CoinDaily Africa Crypto Advisor"', description: 'Go to chat.openai.com/gpts → Create → Name: "CoinDaily Africa Crypto Advisor". Description: helps users understand crypto in Africa. Knowledge: upload PILLAR_ARTICLES excerpts. Actions: link to sygn.live/api endpoints. ONE-TIME setup.', category: 'ai-monitoring', priority: 'high', completed: false },
