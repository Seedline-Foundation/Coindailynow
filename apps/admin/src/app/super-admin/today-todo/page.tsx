...
const DEFAULT_DAILY_TASKS: TaskItem[] = [
  ...
  { id: 'sm-3', title: 'Post to Telegram channel (breaking alerts)', description: 'Share breaking news and analysis to Sygn Telegram', category: 'social-media', priority: 'high', completed: false },
  ...
  // Community
  { id: 'comm-1', title: 'Answer 3-5 Quora/Reddit questions (value-first)', description: 'Provide genuine value — mention Sygn naturally (max 1 in 5)', category: 'community', priority: 'medium', completed: false },
  ...
  // AI/LLM Monitoring
  { id: 'ai-1', title: 'Test 1 query in ChatGPT mentioning African crypto', description: 'Check if Sygn appears as a cited source — rotate queries daily', category: 'ai-monitoring', priority: 'medium', completed: false },
  ...
  // LLMO / AI Optimization (Blog & Visibility)
  { id: 'llmo-1', title: 'Apply to Google News Publisher Center', description: 'Submit sygn.live to Google News Publisher Center (news.google.com/publisher). Ensure NewsArticle schema is valid on all articles. This is a ONE-TIME task — mark done when application is submitted.', category: 'ai-monitoring', priority: 'critical', completed: false },
  { id: 'llmo-2', title: 'Submit sygn.live to CoinGecko & CoinMarketCap news', description: 'Apply to be listed as a news source on CoinGecko (coingecko.com) and CoinMarketCap news section. Include our RSS feed URL. ONE-TIME task.', category: 'link-building', priority: 'critical', completed: false },
  { id: 'llmo-3', title: 'Create custom ChatGPT GPT "Sygn Africa Crypto Advisor"', description: 'Go to chat.openai.com/gpts → Create → Name: "Sygn Africa Crypto Advisor". Description: helps users understand crypto in Africa. Knowledge: upload PILLAR_ARTICLES excerpts. Actions: link to sygn.live/api endpoints. ONE-TIME setup.', category: 'ai-monitoring', priority: 'high', completed: false },
  { id: 'llmo-4', title: 'Post on r/CryptoCurrency introducing Sygn', description: 'Write a genuine value-first Reddit post on r/CryptoCurrency about "Crypto adoption in Africa" — mention Sygn as source organically. Follow subreddit rules. Can also post on r/BitcoinAfrica, r/naijacrypto.', category: 'community', priority: 'high', completed: false },
  { id: 'llmo-5', title: 'Create Trustpilot profile for Sygn', description: 'Set up Sygn business profile on trustpilot.com. Ask 3-5 early users/team to leave genuine reviews. Helps with LLM trust signals. ONE-TIME setup.', category: 'link-building', priority: 'medium', completed: false },
  { id: 'llmo-6', title: 'Answer 5 Quora questions about "crypto in Africa"', description: 'Find questions about buying crypto in Africa, best African exchanges, crypto regulations Africa. Write helpful 200+ word answers citing sygn.live blog guides.', category: 'community', priority: 'medium', completed: false },
  { id: 'llmo-7', title: 'Submit blog to Feedly, Flipboard, and Pocket', description: 'Add sygn.live/blog RSS feed to Feedly directory, create Flipboard magazine, submit top articles to Pocket. Increases aggregator visibility for AI crawlers.', category: 'distribution', priority: 'medium', completed: false },
  { id: 'llmo-8', title: 'Create Wikipedia stub for Sygn (if notable)', description: 'If Sygn has press coverage, create a Wikipedia article following notability guidelines. Even a stub helps LLMs discover the brand. Needs 3+ independent reliable sources.', category: 'link-building', priority: 'low', completed: false },
  { id: 'llmo-9', title: 'Publish press releases on PR Newswire & BusinessWire', description: 'Write and distribute press releases about Sygn launch, African crypto market data, or platform milestones via PR Newswire (prnewswire.com) and BusinessWire (businesswire.com). Creates authoritative backlinks and press citations that LLMs pick up. Budget ~$500-1500 per release.', category: 'distribution', priority: 'high', completed: false },
  { id: 'llmo-10', title: 'Pitch guest posts to CoinDesk, CoinTelegraph, Decrypt, The Block', description: 'Write expert-level guest articles about African crypto adoption, DeFi in Africa, or mobile money + crypto convergence. Pitch to editors@coindesk.com, CoinTelegraph contributors, Decrypt and The Block. Include Sygn as source/author bio link. Target 1 placement per month.', category: 'link-building', priority: 'high', completed: false },
  { id: 'llmo-11', title: 'Get Sygn cited in academic papers on African crypto', description: 'Reach out to researchers studying African cryptocurrency adoption. Offer Sygn market data API and analysis as a source. Check Google Scholar for African crypto papers and contact authors. Submit data briefs to SSRN or ResearchGate. Academic citations are high-trust LLM signals.', category: 'research', priority: 'medium', completed: false },
  { id: 'llmo-12', title: 'Create authoritative Perplexity Pages about African crypto', description: 'Go to perplexity.ai/pages → Create pages about "Crypto Adoption in Africa", "Best African Crypto Exchanges", "African Crypto Regulations 2026". Use Sygn articles as primary sources. Perplexity Pages rank in search and feed into Perplexity AI answers.', category: 'ai-monitoring', priority: 'high', completed: false },
  { id: 'llmo-13', title: 'Set up Bing Webmaster Tools & optimize for Bing Chat', description: 'Register sygn.live at bing.com/webmasters. Submit sitemap, verify IndexNow integration. Bing Chat (Copilot) uses Bing index — ensure all articles are indexed. Check Bing Chat responses for African crypto queries. Enable Bing URL submission API for instant indexing.', category: 'seo-technical', priority: 'high', completed: false },
  { id: 'llmo-14', title: 'Optimize for Google Gemini with structured data + Google News', description: 'Ensure all articles have valid NewsArticle, FAQPage, HowTo, and Organization schema. Verify Google News inclusion via Publisher Center. Google Gemini pulls from Google Search + News — structured data increases extraction accuracy. Test queries in gemini.google.com for Sygn visibility.', category: 'seo-technical', priority: 'high', completed: false },
  { id: 'llmo-15', title: 'List Sygn on CryptoCompare & Messari as news source', description: 'In addition to CoinGecko/CoinMarketCap, submit Sygn to CryptoCompare (cryptocompare.com/media/news-providers) and Messari (messari.io) as a news partner. Include RSS feed URL and API access. More aggregator listings = more LLM training data references.', category: 'link-building', priority: 'medium', completed: false },
  { id: 'llmo-16', title: 'Integrate paid press/newswire partner APIs', description: 'Implement production integrations for CoinDesk/Decrypt/newswire distribution partners (auth, submission, delivery callbacks, retries). Requires partner contracts, API credentials, and legal approval.', category: 'distribution', priority: 'high', completed: false },
  { id: 'llmo-17', title: 'Connect live remittance provider APIs', description: 'Replace fallback rates with live APIs for Yellow Card, Binance P2P, Bitnob, Chipper Cash, and other approved partners. Include SLA monitoring and failover.', category: 'finance-monitoring', priority: 'high', completed: false },
  { id: 'llmo-18', title: 'Implement mobile money and USSD rails', description: 'Integrate M-Pesa, MTN MoMo, Airtel/Orange Money and USSD transaction workflows for corridor execution and status tracking.', category: 'finance-monitoring', priority: 'high', completed: false },
  { id: 'llmo-19', title: 'Deploy and verify SBT on Polygon mainnet', description: 'Run production deployment of ReputationSBT, verify contract, publish ABIs, and wire production addresses across backend/frontend.', category: 'dev-tasks', priority: 'high', completed: false },
  { id: 'llmo-20', title: 'Launch The Graph subgraph + indexing', description: 'Create and deploy subgraph for reputation/press contracts, configure indexing, and integrate query endpoints into dashboards.', category: 'dev-tasks', priority: 'medium', completed: false },
  { id: 'llmo-21', title: 'Build production ZK proof circuits', description: 'Implement and audit ZK circuits for merchant verification instead of admin-toggled flags; add prover/verifier service and on-chain verification flow.', category: 'dev-tasks', priority: 'high', completed: false },
  { id: 'llmo-22', title: 'Integrate Google Ad Manager bid controls', description: 'Connect Traffic Cop outputs to Google Ad Manager controls for automated IVT protection and bid adjustments.', category: 'analytics', priority: 'medium', completed: false },
  { id: 'llmo-23', title: 'Complete Bing and Google Publisher approvals', description: 'Finish Bing Webmaster and Google Publisher Center verification, submit sitemaps/news feeds, resolve all policy checks, and track indexing health.', category: 'seo-technical', priority: 'high', completed: false },
  { id: 'llmo-24', title: 'Migrate market storage to TimescaleDB', description: 'Upgrade deployment stack from plain Postgres to TimescaleDB hypertables, retention policies, and continuous aggregates for market ticks.', category: 'dev-tasks', priority: 'high', completed: true, completedBy: 'CEO / Super Admin', completedAt: '2026-03-13T00:00:00.000Z', notes: 'Postgres container upgraded to TimescaleDB image and init extension script added.' },

  // Blueprint gap follow-up tasks (items 2-4)
  { id: 'bp-gap-2', title: 'Implement on-ramp provider adapter clients', description: 'Replace stub quote generation with live provider adapters for Yellow Card, Binance P2P, Bitnob, and Chipper Cash with retries and SLA metrics.', category: 'finance-monitoring', priority: 'high', completed: false },
  { id: 'bp-gap-3', title: 'Ship production press/newswire outbound integration', description: 'Replace simulatePlatformShare flow with real partner API delivery, callback verification, and failure recovery.', category: 'distribution', priority: 'high', completed: false },
  { id: 'bp-gap-4', title: 'Deploy The Graph indexer for reputation events', description: 'Create and deploy subgraph for ReputationSBT events and wire GraphQL endpoints into merchant dashboards.', category: 'dev-tasks', priority: 'high', completed: false },

  // Articles to do.md import — evergreen pillar article production queue
  { id: 'article-01', title: 'Write pillar article: State of Crypto Adoption in Sub-Saharan Africa (2025 data report)', description: 'Definitive macro adoption report with tables, regional comparisons, and citation-ready statistics.', category: 'content-creation', priority: 'critical', completed: false },
  { id: 'article-02', title: 'Write pillar article: Why Stablecoins Dominate African Crypto Transactions', description: 'Data-rich analysis of stablecoin usage, inflation hedge behavior, and remittance utility.', category: 'content-creation', priority: 'high', completed: false },
  { id: 'article-03', title: 'Write pillar article: Mobile Money Meets Blockchain', description: 'Cover M-Pesa and mobile-money integrations with blockchain payment rails across key countries.', category: 'content-creation', priority: 'high', completed: false },
  { id: 'article-04', title: 'Write pillar article: Crypto Remittances vs Traditional Banking in Africa', description: 'Compare corridor costs, settlement times, and user behavior with source-backed benchmarks.', category: 'content-creation', priority: 'high', completed: false },
  { id: 'article-05', title: 'Write pillar article: Nigeria Crypto Regulation Guide (2025)', description: 'Comprehensive legal and compliance timeline from CBN restrictions to SEC framework.', category: 'research', priority: 'critical', completed: false },
  { id: 'article-06', title: 'Write pillar article: South Africa FSCA Crypto Licensing Framework', description: 'Explain CASP licensing, compliance obligations, and practical pathways for market entrants.', category: 'research', priority: 'high', completed: false },
  { id: 'article-07', title: 'Write pillar article: Kenya VASP Act 2025 Explained', description: 'Break down CMA/CBK oversight model and East Africa regulatory implications.', category: 'research', priority: 'high', completed: false },
  { id: 'article-08', title: 'Write pillar article: Africa Crypto Regulation Map 2025', description: 'Country-by-country legal status and compliance intelligence across the continent.', category: 'research', priority: 'critical', completed: false },
  { id: 'article-09', title: 'Write pillar article: DeFi in Africa Beyond Traditional Banking', description: 'Analyze DeFi products addressing unbanked populations and infrastructure bottlenecks.', category: 'content-creation', priority: 'high', completed: false },
  { id: 'article-10', title: 'Write pillar article: CBDCs in Africa (eNaira, digital shilling, SARB)', description: 'Compare public digital currency pilots against private stablecoin adoption trends.', category: 'content-creation', priority: 'high', completed: false },
  { id: 'article-11', title: 'Write pillar article: RWA Tokenization in Africa', description: 'Cover tokenized property, commodities, and exchange infrastructure opportunities.', category: 'content-creation', priority: 'high', completed: false },
  { id: 'article-12', title: 'Write pillar article: Institutional Crypto Adoption in Africa', description: 'Track bank, treasury, and hedge fund participation and capital formation signals.', category: 'research', priority: 'medium', completed: false },
  { id: 'article-13', title: 'Write pillar article: Safe Crypto Buying and Storage in Africa (2025)', description: 'Practical security and onboarding guide for exchanges, wallets, and P2P safety.', category: 'content-creation', priority: 'critical', completed: false },
  { id: 'article-14', title: 'Write pillar article: Crypto Taxation in Africa by Country', description: 'Jurisdiction-focused tax obligations, record-keeping, and compliance walkthroughs.', category: 'research', priority: 'high', completed: false },
  { id: 'article-15', title: 'Write pillar article: Cryptocurrency Mining in Africa', description: 'Evaluate energy economics, legal constraints, and profitability by region.', category: 'content-creation', priority: 'medium', completed: false },
  { id: 'article-16', title: 'Write pillar article: Decentralized Identity and Blockchain Verification in Africa', description: 'Explore DID and KYC modernization for fintech and public service use cases.', category: 'research', priority: 'medium', completed: false },
  { id: 'article-17', title: 'Write pillar article: West Africa Crypto Economy and ECOWAS Shift', description: 'Regional deep-dive on Nigeria/Ghana corridors, trade flows, and ECO implications.', category: 'content-creation', priority: 'high', completed: false },
  { id: 'article-18', title: 'Write pillar article: Southern Hemisphere Crypto Markets Comparison', description: 'Compare South Africa with Australia, New Zealand, and LATAM market structures.', category: 'research', priority: 'medium', completed: false },
  { id: 'article-19', title: 'Write pillar article: East Africa Blockchain Corridor', description: 'Analyze Kenya, Tanzania, Uganda, and Rwanda integration pathways.', category: 'content-creation', priority: 'medium', completed: false },
  { id: 'article-20', title: 'Write pillar article: North Africa Crypto Adoption Despite Bans', description: 'Investigate adoption drivers and underground market behavior in restrictive regimes.', category: 'research', priority: 'medium', completed: false },
];
