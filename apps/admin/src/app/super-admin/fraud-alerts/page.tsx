...
export default function SuperAdminFraudDashboard() {
      ...
      <div className="max-w-7xl mx-auto">
        ...
        {stats && (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6 mb-8">
            <div className="bg-dark-900 p-6 rounded-lg shadow-sm border border-gray-700">
        ...
        {/* Filters */}
        <div className="bg-dark-900 p-4 rounded-lg shadow-sm border border-gray-700 mb-6">
          <div className="flex items-center gap-4 flex-wrap">
            ...
            <select
              ...
              className="px-3 py-2 border border-gray-600 rounded-lg bg-gray-800 text-gray-100"
            >
        ...
        {/* Alerts List */}
        <div className="bg-dark-900 rounded-lg shadow-sm border border-gray-700">
          ...
          <div className="divide-y divide-gray-700">
                ...
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      {alert.autoFrozen && (
                        <span className="px-2 py-1 rounded text-xs font-semibold bg-red-900/20 text-red-400">
                          <Lock className="w-3 h-3 inline mr-1" />
                          Auto-Frozen
                        </span>
                      )}
                      {alert.resolved && (
                        <span className="px-2 py-1 rounded text-xs font-semibold bg-green-900/20 text-green-400">
            ...
            {filteredAlerts.length === 0 && (
              <div className="p-12 text-center">
                <Shield className="w-16 h-16 text-gray-650 mx-auto mb-4" />
                <p className="text-gray-400">
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                      <label className="text-sm text-gray-400">Fraud Score</label>
                      <p className="font-medium text-gray-100">
