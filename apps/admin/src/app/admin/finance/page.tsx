    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-[60vh] gap-4">
        ...
        <div className="flex gap-3">
          ...
          <a
            href={getCfisDashboardUrl()}
            target="_blank"
            rel="noopener noreferrer"
            className="px-4 py-2 bg-dark-800 hover:bg-dark-700 text-white rounded-lg text-sm font-medium flex items-center gap-2 border border-dark-600"
          >
            <ExternalLink className="w-4 h-4" /> Open CFIS directly
          </a>
        </div>
      </div>
    );
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          >
            <ExternalLink className="w-4 h-4" /> Open CFIS
          </a>
        </div>
      </div>
        ...
        <div className="lg:col-span-2 bg-dark-900 border border-dark-700 rounded-xl overflow-hidden">
          ...
          {pending.length > 15 && (
            <div className="px-5 py-3 border-t border-dark-700">
              ...
              >
                View all {pending.length} in CFIS <ExternalLink className="w-3 h-3" />
              </a>
            </div>
          )}
        </div>
        ...
        <div className="bg-dark-900 border border-dark-700 rounded-xl overflow-hidden">
          ...
          <div className="p-5 space-y-4">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="block w-full px-4 py-2.5 bg-dark-800 hover:bg-dark-700 border border-dark-600 text-white rounded-lg text-sm font-medium text-center transition-colors flex items-center justify-center gap-2"
            >
              <ExternalLink className="w-4 h-4" /> Open Standalone CFIS Dashboard
            </a>
          </div>
        </div>
      </div>
