...
const POST_LAUNCH_ARTICLES: ArticleSeed[] = [
  {
    title: 'Day 1 Recap: Sygn Launch Breaks Traffic Records Across Africa',
    slug: 'launch-day1-recap-sygn-traffic-records',
    excerpt: 'Sygn\'s launch day saw over 100,000 unique visitors from across the continent. Here\'s what our readers were most interested in.',
    content: '<p>What a day! Sygn\'s official launch has exceeded all expectations, with readers from Nigeria, Kenya, South Africa, Ghana, and over 30 other African countries visiting the platform. Our most-read articles covered Bitcoin market analysis, regulatory updates, and DeFi education.</p><p>Thank you to our growing community. This is just the beginning of our mission to deliver Africa-focused crypto news that matters.</p>',
    categorySlug: 'exchange-updates',
    tags: JSON.stringify(['sygn', 'launch', 'recap', 'milestones']),
    territories: ['NG', 'KE', 'ZA', 'GH'],
    readingTimeMinutes: 3,
    priority: 'HIGH',
  },
