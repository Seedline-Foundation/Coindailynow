...
const positions: JobPosition[] = [
  /* ──── Content & Contributor Positions ──── */
  {
    ...
    perks: ['Published byline on articles', 'Sygn author badge', 'Access to community Slack', 'Free Sygn Premium', 'AI writing tools access', 'Paid in Sygn Token'],
    slots: 'Unlimited',
    urgent: false,
    category: 'content',
  },
  {
    ...
    perks: ['Featured author profile', 'Priority editorial calendar', 'Quarterly bonus pool', 'Event speaker invitations', 'Free Sygn Premium', 'Course creation rights', 'Paid in Sygn Token'],
    slots: 20,
    urgent: true,
    category: 'content',
  },
  {
    ...
    perks: ['Premium author page', 'Monthly retainer', 'Revenue share on premium content', 'Conference sponsorship', 'Full AI tools suite', 'Premium podcast hosting', 'Paid in Sygn Token'],
    slots: 10,
    urgent: true,
    category: 'content',
  },
  {
    ...
    description: 'Guide Sygn\'s strategic direction and content quality. Share your network, insights, and brand to accelerate Africa\'s crypto knowledge ecosystem.',
    ...
    perks: ['Top-tier branding', 'Advisory compensation', 'Sygn Token allocation', 'Full editorial control', 'Direct line to CEO', 'Board voting rights', 'Paid in Sygn Token'],
    slots: 5,
    urgent: false,
    category: 'leadership',
  },
  {
    ...
    description: 'Host premium podcast series covering African crypto markets, interviews with industry leaders, and educational content. Help build Sygn\'s audio content library.',
    ...
    perks: ['Professional podcast studio tools', 'Guest booking support', 'Marketing and promotion', 'Premium podcast page', 'Paid in Sygn Token'],
    slots: 8,
    urgent: false,
    category: 'content',
  },
  {
    ...
    description: 'Create comprehensive courses on cryptocurrency trading, blockchain technology, DeFi, regulation, and financial literacy for African audiences. Courses will be sold on Sygn\'s education platform.',
    ...
    perks: ['80% revenue on course sales', 'Course marketing support', 'AI tools for course creation', 'Student engagement analytics', 'Paid in Sygn Token'],
    slots: 15,
    urgent: false,
    category: 'content',
  },
  /* ──── Technical Positions ──── */
  {
    ...
    location: 'Remote — Africa-wide',
    experience: '3+ years',
    compensation: 'Competitive salary (paid in Sygn Token) + Token allocation',
    description: 'Build and maintain Sygn\'s platform using Next.js, TypeScript, Node.js, and PostgreSQL. Work on real-time market data, AI integrations, and user-facing features.',
    ...
    perks: ['Work on cutting-edge AI + crypto platform', 'Token allocation', 'Remote work flexibility', 'Learning budget', 'Paid in Sygn Token'],
    slots: 3,
    urgent: true,
    category: 'tech',
  },
  {
    ...
    compensation: 'Competitive salary (paid in Sygn Token) + Token allocation',
    description: 'Build and optimize Sygn\'s AI agent system — content generation, sentiment analysis, market prediction, translation (15 African languages), and moderation agents.',
    ...
    perks: ['Work on Africa\'s most advanced AI content platform', 'Token allocation', 'Research publication support', 'Conference sponsorship', 'Paid in Sygn Token'],
    slots: 2,
    urgent: true,
    category: 'tech',
  },
  {
    ...
    compensation: 'Competitive salary (paid in Sygn Token) + Token allocation',
    description: 'Develop smart contracts for Sygn Token, staking mechanisms, and DeFi integrations. Build the on-chain infrastructure powering our contributor payment system.',
    ...
    perks: ['Build the token powering Africa\'s crypto media', 'Token allocation', 'Open source contributions', 'Paid in Sygn Token'],
    slots: 2,
    urgent: false,
    category: 'tech',
  },
  {
    ...
    perks: ['Work with Africa\'s largest crypto dataset', 'Token allocation', 'Premium tool access', 'Paid in Sygn Token'],
    slots: 3,
    urgent: true,
    category: 'tech',
  },
  {
    ...
    experience: '3+ years',
    compensation: 'Competitive salary (paid in Sygn Token) + Token allocation',
    description: 'Manage Sygn\'s Docker-based infrastructure on Contabo VPS. Handle CI/CD pipelines, monitoring (Elasticsearch), CDN (Cloudflare), and ensure <500ms API response times.',
    ...
    perks: ['Architect Africa\'s crypto infrastructure', 'Token allocation', 'Learning budget', 'Paid in Sygn Token'],
    slots: 1,
    urgent: false,
    category: 'tech',
  },
  {
    ...
    compensation: 'Competitive salary (paid in Sygn Token) + Token allocation',
    description: 'Build Sygn\'s mobile app — PWA and native features for real-time market alerts, news reading, and contributor tools. Optimize for African mobile networks and devices.',
    ...
    perks: ['Build the app for millions of African crypto users', 'Token allocation', 'Device testing budget', 'Paid in Sygn Token'],
    slots: 2,
    urgent: false,
    category: 'tech',
  },
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="text-center mb-10">
          ...
          <h1 className="text-4xl md:text-5xl font-black text-gray-900 dark:text-white mb-4">
            Join Sygn — Shape Africa&apos;s Crypto Future
          </h1>
          ...
          <div className="inline-flex items-center gap-2 px-5 py-2 bg-gradient-to-r from-orange-500 to-yellow-500 text-white rounded-full text-sm font-bold mb-6">
            💎 ALL compensation paid in Sygn Token
          </div>
        ...
        <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-8 text-white text-center mb-16">
          <h3 className="text-2xl font-bold mb-6">Why Work With Sygn?</h3>
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 max-w-5xl mx-auto">
            {[
              ...
              { icon: '💎', title: 'Token Compensation', desc: 'Earn Sygn Token with staking rewards' },
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl max-w-lg w-full p-6 border dark:border-gray-700 max-h-[85vh] overflow-y-auto" onClick={e => e.stopPropagation()}>
            {applied ? (
              <div className="text-center py-8">
                ...
                <p className="text-xs text-gray-400">All compensation paid in Sygn Token.</p>
              ...
              <>
                ...
                <form className="space-y-4" onSubmit={e => { e.preventDefault(); setApplied(true); }}>
                  ...
                  <div>
                    ...
                    <textarea required rows={4} placeholder="Tell us about your experience and why you want to join Sygn..."
                  ...
                  <p className="text-xs text-gray-400 text-center">Reviewed within 48 hours. All compensation in Sygn Token.</p>
                </form>
              </>
            )}
          </div>
