...
export const metadata = {
  title: 'Disclaimer - Sygn Africa',
  description: 'Financial disclaimer and risk warning for Sygn Africa cryptocurrency news platform.',
};
          ...
          <div className="prose prose-gray max-w-none space-y-6">
            <div className="bg-yellow-50 border-l-4 border-yellow-400 p-4 rounded-r-lg mb-8">
              <p className="text-yellow-800 font-medium">
                Important: Sygn Africa is a news and information platform. Nothing on this site constitutes financial, investment, legal, or tax advice.
              </p>
            </div>
            ...
            <section>
              ...
              <p className="text-gray-600 leading-relaxed">
                The information provided on Sygn Africa is for general informational and educational purposes only. All information on the site is provided in good faith; however, we make no representation or warranty of any kind, express or implied, regarding the accuracy, adequacy, validity, reliability, availability, or completeness of any information on the site.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-gray-600 leading-relaxed">
                Sygn Africa does not provide financial, investment, legal, or tax advice. The content published on this platform, whether written by human journalists or generated with AI assistance, is intended solely for informational purposes. You should not construe any information or content on this platform as financial, investment, legal, or tax advice.
              </p>
              <p className="text-gray-600 leading-relaxed mt-3">
                Before making any financial decisions, consult a qualified, licensed financial advisor who understands your personal circumstances. Sygn Africa, its editors, writers, and affiliates are not responsible for any financial losses incurred as a result of acting on information published on this platform.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-gray-600 leading-relaxed">
                Cryptocurrency and digital asset investments carry significant risk. The value of digital assets can fluctuate dramatically, and you could lose all of your invested capital. Past performance is not indicative of future results. Sygn Africa does not recommend buying, selling, or holding any cryptocurrency or digital asset.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-gray-600 leading-relaxed">
                Some content on Sygn Africa is generated or assisted by artificial intelligence systems. While we strive for accuracy and employ human editorial review processes, AI-generated content may contain errors or inaccuracies. Always verify critical information from official sources before making decisions.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-gray-600 leading-relaxed mt-3">
                This disclaimer applies to all African jurisdictions where Sygn is accessible, including but not limited to Nigeria, Kenya, South Africa, Ghana, Tanzania, Ethiopia, and the broader African diaspora.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-gray-600 leading-relaxed">
                In no event shall Sygn Africa, its directors, employees, partners, agents, suppliers, or affiliates be liable for any indirect, incidental, special, consequential, or punitive damages, including without limitation, loss of profits, data, use, goodwill, or other intangible losses, resulting from your access to or use of or inability to access or use the platform.
              </p>
            </section>
          </div>
