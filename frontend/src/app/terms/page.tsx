...
const sections = [
  {
    ...
    content:
      'By accessing and using Sygn ("the Platform"), operated by Sygn Media Ltd, you agree to be bound by these Terms of Service ("Terms"). If you do not agree with any part of these Terms, you must not use the Platform. These Terms apply to all visitors, users, subscribers, API consumers, and press release submitters.',
  },
  {
    title: '2. Description of Service',
    content:
      'Sygn provides cryptocurrency and finance news, real-time market data, analysis tools, AI-generated content, regulatory tracking, tax calculators, exchange-rate tools, remittance calculators, on-ramp aggregation, and community features focused on the African crypto and fintech ecosystem. The Platform also offers a press release distribution service, a Knowledge API for programmatic data access, and premium subscription tiers with enhanced features.',
  },
  {
    title: '3. Not Financial Advice',
    content:
      'IMPORTANT: All content on Sygn, including AI-generated articles, market analysis, price data, tax calculations, and editorial commentary, is for informational purposes only and does not constitute financial, investment, tax, or legal advice. Cryptocurrency and digital-asset markets are highly volatile and speculative. Always conduct your own research and consult a licensed financial advisor in your jurisdiction before making investment decisions. Sygn is not a broker, exchange, or licensed financial institution.',
  },
  {
  ...
  },
  {
    title: '12. Cookies',
    content:
      'Sygn uses cookies and similar technologies as described in our Privacy Policy. By using the Platform, you consent to our use of essential cookies. Non-essential cookies (analytics, marketing) require your explicit consent via our cookie banner. You may withdraw consent at any time.',
  },
  {
    title: '13. Third-Party Services',
    content:
      'The Platform integrates with third-party services including payment processors (YellowCard, ChangeNOW), market data providers, and translation services. Your use of these services is subject to their respective terms. Sygn is not responsible for the availability, accuracy, or security of third-party services.',
  },
  {
    title: '14. Limitation of Liability',
    content:
      'To the maximum extent permitted by law, Sygn Media Ltd, its directors, employees, and agents are not liable for any direct, indirect, incidental, special, or consequential damages arising from: (a) your use of, or inability to use, the Platform; (b) reliance on any content, data, or tools; (c) cryptocurrency or financial investment decisions; (d) unauthorised access to your account; (e) interruption or cessation of services. Our total aggregate liability shall not exceed the total fees you paid for subscription services in the 12 months preceding the claim.',
  },
  {
    title: '15. Indemnification',
    content:
      'You agree to indemnify and hold harmless Sygn Media Ltd from any claims, damages, losses, or expenses (including legal fees) arising from: (a) your violation of these Terms; (b) your use of the Platform; (c) content you submit; (d) your violation of any law or third-party rights.',
  },
  {
