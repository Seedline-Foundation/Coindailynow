          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow">
              ...
              <div className="p-6 grid grid-cols-2 md:grid-cols-4 gap-4">
                <Link href="/admin/content/live-manager" className="p-4 border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-lg hover:border-blue-500 dark:hover:border-blue-400 text-center group">
                ...
                <Link href="/admin/analytics/topics" className="p-4 border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-lg hover:border-green-500 dark:hover:border-green-400 text-center group">
                ...
                <Link href="/admin/content/smart-filter" className="p-4 border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-lg hover:border-purple-500 dark:hover:border-purple-400 text-center group">
                ...
                <Link href="/admin/content/recommendations" className="p-4 border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-lg hover:border-yellow-500 dark:hover:border-yellow-400 text-center group">
