...
echo "2. sudo nano /var/www/sygn-app/.env  # update both keys"
echo "3. pm2 restart sygn-backend --update-env"
echo "4. pm2 save"
echo "5. Verify: curl -s https://app.sygn.live/health | head -c 200"
